...
metadata_files <- list.files("source/QC_metadata_RN011/")
...
for (metadata_file in metadata_files){
  ...
  current_metadata <- readRDS(paste0("source/QC_metadata_RN011/", metadata_file))
  # print(metadata_file)
...
filtered_summary <- summary[summary$row_count > 40, ]
...
final_columns <- pseudo_bulk_columns

saveRDS(final_columns, "interm/final_columns_40_subtype.rds")
