...
validation_metrics_SEED <- readRDS("source/validation_RN012_mean.rds")
...
putative                 <- validation_metrics_SEED[, c("study", "mean_putative")]
putative$set_type        <- "putative"
colnames(putative)[1:2]  <- c("study", "ARI")
canonical                <- validation_metrics_SEED[, c("study", "mean_canonical")]
...
p
ggsave(filename = "figures/SEED/Figure - 3A - LOO-ARI scores.png", plot = p, device = "png", width = 4000, height = 2100, units = "px")
...
putative                 <- validation_metrics_SEED[, c("study", "putative_accuracy")]
putative$set_type        <- "putative"
colnames(putative)[1:2]  <- c("study", "accuracy")
canonical                <- validation_metrics_SEED[, c("study", "canonical_accuracy")]
canonical$set_type       <- "canonical"
...
p <- ggplot(ARI_plot_data, aes(study, value, fill = set_type)) + geom_bar(stat="identity", position = "dodge", width=0.65) +
                                                                  #  labs(title="Multiple Bar plots")                    +
                                                                    ...
                                                                    theme(axis.text.x = element_text(angle = 45, size = 20, hjust = 1),
                                                                          ...
                                                                          axis.title.y = element_text(size = 20))
p
ggsave(filename = "figures/SEED/Figure - 3B - LOO-accuracy scores.png", plot = p, device = "png", width = 4000, height = 2100, units = "px")
...
putative                 <- validation_metrics_SEED[, c("study", "putative_macro_F1")]
putative$set_type        <- "putative"
colnames(putative)[1:2]  <- c("study", "F1")
canonical                <- validation_metrics_SEED[, c("study", "canonical_macro_F1")]
canonical$set_type       <- "canonical"
...
p <- ggplot(ARI_plot_data, aes(study, value, fill = set_type)) + geom_bar(stat="identity", position = "dodge", width=0.65) +
                                                                  #  labs(title="Multiple Bar plots")                    +
                                                                    ...
                                                                    theme(axis.text.x = element_text(angle = 45, size = 20, hjust = 1),
                                                                          ...
                                                                          axis.title.y = element_text(size = 20))
p
ggsave(filename = "figures/SEED/Figure - 3C - LOO-ARI macro_F1.png", plot = p, device = "png", width = 4000, height = 2100, units = "px")
...
p
ggsave(
  filename = "figures/SEED/split_violin_metrics.png",
  plot = p,
...
plot_mean_data <- df %>%
  ...
  summarise(mean_value = mean(value), SD = sd(value), .groups = "drop")
