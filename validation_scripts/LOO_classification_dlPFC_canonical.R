...
markers    <- unique(readRDS("../rds_files/validation_Gene_lists/canonical_dlPFC_subtypes_RN012.rds"))
...
saveRDS(result, "results/RN012/LOO_classification_dlPFC_RN012_canonical.rds")
